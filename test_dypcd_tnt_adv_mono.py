...
conf_all = {'Auditorium':0.075, 'Ballroom':0.01, 'Courtroom':0.1, 'Museum':0.01, 'Palace':0.01, 'Temple':0.01}
dist_all = {'Auditorium':1/1*d_r['Auditorium'], 'Ballroom':1/1*d_r['Ballroom'], 'Courtroom':1/1*d_r['Courtroom'],
            'Museum':1/0.5*d_r['Museum'], 'Palace':1/0.5*d_r['Palace'], 'Temple':1/0.5*d_r['Temple']}
rel_diff_all = {'Auditorium':1/200*r_r['Auditorium'], 'Ballroom':1/1200*r_r['Ballroom'], 'Courtroom':1/800*r_r['Courtroom'],
                'Museum':1/1600*r_r['Museum'], 'Palace':1/1600*r_r['Palace'], 'Temple':1/1600*r_r['Temple']}
