...
# def dypcd_filter(testlist, number_worker=1):
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for filename, cam, img, depth_est, photometric_confidence in zip(filenames, cams, imgs, \
                ...
                for stageid in range(1,5):
                    depth_jpg_filename = os.path.join(args.outdir, filename.format('depth_est', '{}_{}.jpg'.format('stage',
                                                                                                                   str(stageid))))
                    stage_depth = outputs['stage{}'.format(stageid)]['maskup_depth'][0]
